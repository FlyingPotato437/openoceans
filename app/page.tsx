    ...
    <>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between">
            <div className="lg:w-1/2 py-16 lg:pr-12 z-20 relative">
              <div className="max-w-2xl relative">
                ...
                <h1 className="text-5xl md:text-7xl font-extrabold mb-8 leading-tight tracking-tight font-serif">
                  ...
                  <div className="overflow-hidden mt-1">
                    <span className="inline-block animate-slide-up-fade animation-delay-100 text-black dark:text-white [text-shadow:0_4px_8px_rgba(0,0,0,0.1)]">
                      For a <span className="relative inline-block font-cursive italic">
                        Sustainable
                ...
                <div className="overflow-hidden mb-8">
                  <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 animate-slide-up-fade animation-delay-200 leading-relaxed font-handwritten">
                    Access comprehensive ocean monitoring data from our 
                    <span className="relative inline-block px-1">
                      <span className="relative z-10 text-ocean-600 dark:text-ocean-400 font-medium font-serif">global network</span>
                      <span className="absolute inset-0 bg-ocean-100 dark:bg-ocean-900/40 rounded-md -z-0 transform -rotate-1 doodle-border"></span>
                    </span>
                    of REEFlect smart buoys.
                    <span className="block mt-3 text-lg md:text-xl opacity-85 wavy-text font-handwritten">
                      Free to download, analyze, and use for 
                      <span className="font-medium text-blue-600 dark:text-blue-400 ml-1 font-serif">research</span>, 
                      <span className="font-medium text-seagrass-600 dark:text-seagrass-400 mx-1 font-serif">education</span>, and 
                      <span className="font-medium text-ocean-600 dark:text-ocean-400 ml-1 font-serif">conservation</span>.
                    </span>
                  </p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mb-12 animate-slide-up-fade animation-delay-300">
                  <a 
                    href="/map" 
                    className="px-6 py-3 bg-gradient-to-r from-ocean-600 to-blue-600 hover:from-ocean-700 hover:to-blue-700 text-white rounded-lg transition transform hover:-translate-y-1 flex items-center justify-center shadow-lg font-serif blob-shape"
                  >
                  ...
                  <a 
                    href="/data/download" 
                    className="px-6 py-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition transform hover:-translate-y-1 flex items-center justify-center shadow-md text-gray-800 dark:text-gray-200 blob-shape font-handwritten"
                  >
                ...
                <div className="flex items-center gap-8 flex-wrap overflow-hidden">
                  ...
                  <div className="flex items-center gap-3 animate-slide-up-fade animation-delay-600 transform hover:scale-105 transition-transform duration-300 group">
                    ...
                    <div>
                      <p className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 font-medium font-handwritten">Buoys Deployed</p>
                  ...
                  <div className="flex items-center gap-3 animate-slide-up-fade animation-delay-700 transform hover:scale-105 transition-transform duration-300 group">
                    ...
                    <div>
                      <p className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 font-medium font-handwritten">Research Partners</p>
      ...
      <section className="py-20 bg-white dark:bg-black">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <div className="inline-flex items-center px-3 py-1 rounded-md bg-ocean-50/80 dark:bg-ocean-900/40 mb-6 backdrop-blur-sm border border-ocean-200 dark:border-ocean-800/30 hand-drawn-box">
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300 font-handwritten leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl border-l-4 border-ocean-600 hover:shadow-md transition-shadow duration-300 hand-drawn-box relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="w-12 h-12 bg-ocean-50/80 dark:bg-ocean-900/40 rounded-xl flex items-center justify-center mb-4 backdrop-blur-sm shadow-inner doodle-border">
                  <Database className="h-6 w-6 text-ocean-600 dark:text-ocean-400" />
                </div>
                <h3 className="text-xl font-serif font-bold text-black dark:text-white mb-2">Open Access</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-2 font-handwritten leading-relaxed">All data collected by our buoys is freely available under open-source licenses for research, education, and innovation.</p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl border-l-4 border-ocean-600 hover:shadow-md transition-shadow duration-300 hand-drawn-box relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-serif font-bold text-gray-900 dark:text-white mb-2">Global Collaboration</h3>
                <p className="text-gray-600 dark:text-gray-400 font-handwritten leading-relaxed">
            ...
            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl border-l-4 border-ocean-600 hover:shadow-md transition-shadow duration-300 hand-drawn-box relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-serif font-bold text-gray-900 dark:text-white mb-2">Data Transparency</h3>
                <p className="text-gray-700 dark:text-gray-300 font-handwritten leading-relaxed">
      ...
      <section id="explore-map" className="py-20 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-black">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <div className="inline-flex items-center px-3 py-1 rounded-md bg-ocean-50/80 dark:bg-ocean-900/40 mb-6 backdrop-blur-sm border border-ocean-200 dark:border-ocean-800/30 hand-drawn-box">
              <span className="text-sm font-handwritten text-ocean-600 dark:text-ocean-400 uppercase tracking-wider">Explore</span>
            </div>
            <h2 className="text-3xl font-serif font-bold text-gray-900 dark:text-white mb-4">Global Buoy Network</h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 font-handwritten leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            <div className="lg:col-span-2">
              <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-200 dark:border-gray-700 hand-drawn-box">
                <h3 className="text-xl font-serif font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                  <Globe2 className="h-5 w-5 text-ocean-500" />
                  <span>Interactive Map</span>
                </h3>
                <p className="text-gray-600 dark:text-gray-400 mb-4 font-handwritten">Click on a buoy marker to view detailed real-time data.</p>
                <div className="rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 doodle-border">
                  <MapComponent 
            ...
            <div>
              <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 h-full border border-gray-200 dark:border-gray-700 hand-drawn-box">
                <h3 className="text-xl font-serif font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                ...
                <div className="space-y-4 overflow-y-auto max-h-[500px] pr-2">
                  {buoys.slice(0, 3).map((buoy) => (
                    <div 
                      key={buoy.id}
                      className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-ocean-300 dark:hover:border-ocean-700 transition-colors cursor-pointer bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm doodle-border"
                      onClick={() => handleBuoySelect({ id: buoy.id })}
                    >
                      <div className="flex justify-between items-start mb-2">
                        <h4 className="font-serif font-semibold text-gray-900 dark:text-white">{buoy.name}</h4>
                        <span className="text-xs px-2 py-1 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded-full font-handwritten">
                          Live
                        </span>
                      </div>
                      ...
                      <div className="mb-3 rounded-lg overflow-hidden shadow-sm doodle-border">
                        <MiniMap 
                      ...
                      <div className="text-sm flex items-center gap-2 text-gray-700 dark:text-gray-300 font-mono">
                  ...
                  <button 
                    className="w-full py-2 text-ocean-600 dark:text-ocean-400 hover:text-ocean-700 dark:hover:text-ocean-300 font-medium flex items-center justify-center gap-1 font-handwritten blob-shape"
      ...
      <section id="download-data" className="py-16 bg-gradient-to-b from-ocean-50/50 to-white dark:from-ocean-950/30 dark:to-black">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <div className="inline-flex items-center px-3 py-1 rounded-md bg-ocean-50/80 dark:bg-ocean-900/40 mb-6 backdrop-blur-sm border border-ocean-200 dark:border-ocean-800/30 hand-drawn-box">
              <span className="text-sm font-handwritten text-ocean-600 dark:text-ocean-400 uppercase tracking-wider">Data</span>
            </div>
            <h2 className="text-3xl font-serif font-bold mb-4 text-center">Download Ocean Data</h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 font-handwritten leading-relaxed">
          ...
          <div className="mb-8 flex flex-wrap justify-center gap-4">
            <div className="flex items-center space-x-2 bg-white/90 dark:bg-gray-800/90 p-2 rounded-lg backdrop-blur-sm border border-gray-200 dark:border-gray-700 doodle-border">
              <span className="text-sm font-handwritten">Format:</span>
              <select 
                defaultValue="csv" 
                className="bg-transparent text-sm p-1 rounded border border-gray-300 dark:border-gray-700 font-mono"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {HOMEPAGE_DATASETS.map((dataset) => (
              <div 
                key={dataset.id}
                className="bg-white/90 dark:bg-gray-800/90 rounded-xl hover:shadow-lg transition-shadow duration-300 overflow-hidden backdrop-blur-sm border border-gray-200 dark:border-gray-700 hand-drawn-box"
              >
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    <div className="w-10 h-10 rounded-full bg-ocean-100 dark:bg-ocean-900/40 flex items-center justify-center mr-3 shadow-inner doodle-border">
                      {dataset.icon}
                    </div>
                    <h3 className="text-lg font-serif font-bold text-gray-900 dark:text-white mb-2">{dataset.name}</h3>
                  </div>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-3 flex-grow font-handwritten leading-relaxed">{dataset.description}</p>
                  ...
                  <button 
                    className="w-full py-2.5 px-4 bg-gradient-to-r from-ocean-600 to-blue-600 hover:from-ocean-700 hover:to-blue-700 text-white rounded-xl transition flex items-center justify-center hover:shadow-lg font-serif blob-shape"
                  >
      ...
      <section className="py-20 bg-gradient-to-b from-white to-gray-50 dark:from-black dark:to-gray-900">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <div className="inline-flex items-center px-3 py-1 rounded-md bg-ocean-50/80 dark:bg-ocean-900/40 mb-6 backdrop-blur-sm border border-ocean-200 dark:border-ocean-800/30 hand-drawn-box">
              <span className="text-sm font-handwritten text-ocean-600 dark:text-ocean-400 uppercase tracking-wider">Parameters</span>
            </div>
            <h2 className="text-3xl font-serif font-bold text-gray-900 dark:text-white mb-4">Key Parameters We Monitor</h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 font-handwritten leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white/90 dark:bg-gray-900/90 p-6 rounded-xl hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-gray-700 backdrop-blur-sm hover:scale-105 transform hand-drawn-box">
              <div className="w-12 h-12 bg-blue-100/80 dark:bg-blue-900/30 rounded-full flex items-center justify-center mb-4 shadow-inner doodle-border">
                <Thermometer className="h-6 w-6 text-blue-600 dark:text-blue-400" />
              </div>
              <h3 className="text-xl font-serif font-medium text-gray-900 dark:text-white mb-2">Temperature Monitoring</h3>
              <p className="text-gray-600 dark:text-gray-400 font-handwritten leading-relaxed">
            ...
            <div className="bg-white/90 dark:bg-gray-900/90 p-6 rounded-xl hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-gray-700 backdrop-blur-sm hover:scale-105 transform blob-shape">
              <div className="w-12 h-12 bg-purple-100/80 dark:bg-purple-900/30 rounded-full flex items-center justify-center mb-4 shadow-inner doodle-border">
                <Waves className="h-6 w-6 text-purple-600 dark:text-purple-400" />
              </div>
              <h3 className="text-xl font-serif font-medium text-gray-900 dark:text-white mb-2">pH & Acidification</h3>
              <p className="text-gray-600 dark:text-gray-400 font-handwritten leading-relaxed">
            ...
            <div className="bg-white/90 dark:bg-gray-900/90 p-6 rounded-xl hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-gray-700 backdrop-blur-sm hover:scale-105 transform doodle-border">
              <div className="w-12 h-12 bg-ocean-100/80 dark:bg-ocean-900/30 rounded-full flex items-center justify-center mb-4 shadow-inner doodle-border">
                <Droplet className="h-6 w-6 text-ocean-600 dark:text-ocean-400" />
              </div>
              <h3 className="text-xl font-serif font-medium text-gray-900 dark:text-white mb-2">Salinity Analysis</h3>
              <p className="text-gray-600 dark:text-gray-400 font-handwritten leading-relaxed">
            ...
            <div className="bg-white/90 dark:bg-gray-900/90 p-6 rounded-xl hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-gray-700 backdrop-blur-sm hover:scale-105 transform hand-drawn-box">
              <div className="w-12 h-12 bg-seagrass-100/80 dark:bg-seagrass-900/30 rounded-full flex items-center justify-center mb-4 shadow-inner doodle-border">
                <Beaker className="h-6 w-6 text-seagrass-600 dark:text-seagrass-400" />
              </div>
              <h3 className="text-xl font-serif font-medium text-gray-900 dark:text-white mb-2">Dissolved Oxygen</h3>
              <p className="text-gray-600 dark:text-gray-400 font-handwritten leading-relaxed">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-teal-500 to-blue-600 rounded-xl shadow-lg overflow-hidden text-white backdrop-blur-sm border border-teal-400/20 hand-drawn-box">
              <div className="p-8">
                <h3 className="text-2xl font-serif font-bold mb-4 flex items-center gap-2">
                  <Atom className="h-5 w-5" />
                  API Access
                </h3>
                <p className="mb-6 opacity-90 font-handwritten leading-relaxed">
                  For real-time data integration, use our comprehensive REST API with documentation and sample code.
                </p>
                <div className="bg-white/10 p-4 rounded-lg mb-6 font-mono text-sm overflow-x-auto border border-white/20 shadow-inner doodle-border">
                  <code>curl -X GET https://api.reeflect.org/v1/buoys/B001/data \<br />
                  -H "Authorization: Bearer YOUR_API_KEY"</code>
                </div>
                <Link 
                  href="/api" 
                  className="inline-flex items-center gap-2 bg-white text-teal-600 px-4 py-2.5 rounded-xl font-medium hover:bg-gray-100 transition-colors hover:shadow-md font-serif blob-shape"
                >
            ...
            <div className="bg-gradient-to-br from-ocean-900 via-gray-900 to-ocean-900/80 rounded-xl shadow-lg overflow-hidden text-white backdrop-blur-sm border border-ocean-700/30 hand-drawn-box">
              <div className="p-8">
                <h3 className="text-2xl font-serif font-bold mb-4 flex items-center gap-2">
                ...
                <ul className="mb-6 space-y-3 opacity-90 font-handwritten">
                ...
                <Link 
                  href="/partners" 
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-ocean-600 to-blue-600 hover:from-ocean-700 hover:to-blue-700 text-white px-4 py-2.5 rounded-xl font-medium transition-all hover:shadow-md transform hover:-translate-y-0.5 font-serif blob-shape"
                >
